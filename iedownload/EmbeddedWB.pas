...
{$IFDEF VER140}Variants, {$ENDIF}
  ...
  EXTCtrls, OleCtrls, Mshtml, SHDocVw, ActiveX, shlObj, Wininet,
  Urlmon, shellapi, Variants;
...
{$ENDIF}
  ...
  published
    ...
    function Get_IsOnline: WordBool; stdcall;
    procedure Set_IsOnline(Value: WordBool); stdcall;
...
function TEmbeddedWB.Get_IsOnline: WordBool;
begin
  Result:= False;
end;

procedure TEmbeddedWB.Set_IsOnline(Value: WordBool);
begin
  //
end;
